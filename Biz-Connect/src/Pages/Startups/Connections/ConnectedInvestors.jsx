...
const ConnectedInvestors = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      await axios.get("http://localhost:5000/api/GetConnectedInvestors" ,{
        headers: {
  ...
  return (
    <div className="investor-container min-h-screen mt-[-84px] p-5 mx-auto max-w-7xl">
      <div className="text-center my-8">
        <h1 className="text-2xl font-bold">List of Investors Who Have Requested Connection</h1>
      </div>
      ...
      <div className="relative flex space-x-8">
        <div className="w-[750px] p-10 ">
          ...
          {investors.length>0 ? (
            ...
            <div className="text-center my-8">
        <h1 className="text-2xl font-bold">There are No Investors Who Have Requested Connection</h1>
      </div>
...
export default ConnectedInvestors;

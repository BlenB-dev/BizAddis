...
const InvestorDetails = () => {
        ...
        headers: {
          ...
          "Content-Type": "application/json",
            ...
            if(response.data.length>0){
                ...
                await axios.post("http://localhost:5000/api/GetConnectionStatusForStartupByInvestorID", newForm, {
                  headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "application/json",
                  },
  ...
  const  AcceptInvestor =  () => {
    console.log("Accepting Investor");
    ...
    axios.post("http://localhost:5000/api/StartupAcceptInvestorConnection", newForm, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
      },
  ...
  const  DeclineInvestor =  () => {
    ...
    axios.post("http://localhost:5000/api/StartupDeclineInvestorConnection", newForm, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
      },
            ...
            {(ConnectType == null || ConnectType.length == 0) ? (
              ...
              {ConnectReply === 'Unanswered' ? (
                <div >
                  ...
                  <div >
                    <p className="bg-white-500 text-blue-500 px-4 py-2 mx-5 rounded border border-blue-500">You Have Accepted This Investors Connection</p>
                  </div>

                  
                ) : ConnectReply === 'Decline' ? (
                  <div >
                    <p className="bg-white-500 text-red-500 px-4 py-2 mx-5 rounded border border-red-500">You Have Declined This Investors Connection</p>
                  </div>

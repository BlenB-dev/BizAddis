...
const InvestorProfileCreate = () => {
  ...
  const [investors, setInvestors] = useState({
    ...
    RiskTolerance: "Low",
    FollowOnInvestmentCapacity: "No",
    CoInvestmentOpportunities: "No",
    MentorshipCapabilities: "No",

    NetworkConnections: "",
    PriorStartupExperience: "No",
...
console.log(pref);
    ...
    try {
       const response = await axios.post("http://localhost:5000/api/auth/createInvestorProfile", formPayload, {
        headers: {

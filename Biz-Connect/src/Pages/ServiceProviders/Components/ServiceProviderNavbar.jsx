...
import { navItemsForServiceProvider } from "../../../constants";
import ServiceProviderAccount from "./ServiceProviderAccount";
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-800 p-4 space-y-4">
            <ul role="navigation" className="space-y-4">
              {navItemsForServiceProvider.map((item, index) => (
                <li
                  key={index}
